...
GraficoAcertoSaque([saquesLevantador.slice(0, 4).reduce((acc, valorAtual) => acc + valorAtual, 0), saquesLevantador[4]], 'grafico_erros_saques_levantador', 'grafico_erros_saques_levantador_local')
GraficoTiposSaque(saquesLevantador.slice(0, 4), 'grafico_tipos_saques_levantador', 'grafico_tipos_saques_levantador_local')