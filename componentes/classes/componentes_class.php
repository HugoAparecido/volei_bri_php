...
<div class="container text-center">
    <!-- Cria um container centralizado para a pesquisa -->
    <h1 class="mt-4 mb-4">Pesquisar <?= $item ?></h1>
    <!-- Exibe o título da pesquisa com o nome do item passado por parâmetro -->

    <form action="" method="post" class="mb-4" id="<?= $idForm ?>">
        <!-- Formulário para a pesquisa, com método POST e ID dinâmico -->
        <div class="col-12">
